...
\begin{itemize}
  ...
  \item Combined perception and planning pipelines with computer vision and deep learning for constrained-environment manipulation
  \item Automated validation and deployment using CI/CD pipelines and containerized builds for reproducible research
\end{itemize}
\vspace{0.5em}
