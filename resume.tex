...
\begin{itemize}
  \item Developed \href{https://github.com/MGross21/armctl}{armctl}, a vendor-agnostic Python API for multi-platform manipulator control with $<$10 ms motion latency
